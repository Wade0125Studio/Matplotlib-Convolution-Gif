# -*- coding: utf-8 -*-
"""
Created on Fri Sep 23 10:47:43 2022

@author: GIGABYTE
"""
#https://www.796t.com/post/Mjhzem0=.html
...
im_va = ax_va.imshow(va_color, vmin=0., vmax=1.3, cmap="Reds")
...
im_res = ax_res.imshow(res, vmin=0, vmax=1.3, cmap="Blues")
res_texts = []
...
ani.save("convolution.gif", writer="imagemagick")
plt.show()